...
async function updateWebview(setPage: string, panel: vscode.WebviewPanel, context: vscode.ExtensionContext, currentFolderName: string, currentFolderPath: string, files: any) {
...
export async function deleteFolder(folderName: string, folderPath: string, context: vscode.ExtensionContext, panel: vscode.WebviewPanel, setPage: string, currentFolderName: string, currentFolderPath: string, files: any): Promise<void> {
    try {
